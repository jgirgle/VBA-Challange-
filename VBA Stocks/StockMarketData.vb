        ...
        For i = 2 To row_len
            ...
            If ws.Cells(i + 1, 1).Value <> ws.Cells(i, 1).Value Then
                ...
                If (year_open = 0) Then
                    ...
                    Percent_change  = 0
                Else
                    'Calculate Year_change and Percent_change
                ...
                ws.Range("L" & summary_row).Value = Year_change
                ...
                If ws.Range("L" & summary_row).Value < 0 Then
                    ws.Range("L" & summary_row).Interior.Color = RGB(255, 0, 0)
                Else
                    ws.Range("L" & summary_row).Interior.Color = RGB(0, 255, 0)
                End If
